...
const Dress = () => {
    ...
    const filteredDressProds = prods.filter(prod=> prod.clothe === 'dress')

    const soldThisWeek = filteredDressProds.filter(prod => prod.id % 2 === 0)

    const cheapOnes = filteredDressProds.filter(prod => prod.price < 100)
