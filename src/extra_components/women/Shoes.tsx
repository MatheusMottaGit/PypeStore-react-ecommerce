...
const Shoes = () => {
    ...
    const filteredShoesProds = prods.filter(
      prod => prod.clothe === 'shoes' && prod.category === "women's"
    )

    const soldThisWeek = filteredShoesProds.filter(prod => prod.id % 2 === 0)

    const cheapOnes = filteredShoesProds.filter(prod => prod.price < 100)
